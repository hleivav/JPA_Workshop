...
public class AppCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
       ...
       /* Details details1 = new Details("hleiva@hotmail.com", "Hernan Leiva", LocalDate.of(1963,8,30));
        ...
        System.out.println(appUserRepository.findByUsername("herlei").toString());;
        System.out.println("The number of raws is: " + appUserRepository.count());;
        System.out.println(appUserRepository.findByUsername("seblei").toString());;
        System.out.println(appUserRepository.findByRegDateBetween(LocalDate.of(2025,1,12), LocalDate.of(2025,1,15))); */
    }
}
